...
class FileNotebookTests: XCTestCase {
    ...
    func testFileNotebook_whenAddNoteWithChangedInfo_updateNoteInNotes() {
        ...
        XCTAssertNotEqual(note2.title, checkedNote.title)
        XCTAssertNotEqual(note2.content, checkedNote.content)
        XCTAssertNotEqual(note2.importance, checkedNote.importance)
        XCTAssertNotEqual(note2.color, checkedNote.color)
